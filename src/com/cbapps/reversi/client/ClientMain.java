...
public class ClientMain extends Application implements ReversiConstants {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        boardLayout = new StackPane();
        boardLayout.getChildren().add(borderPane);

        boardScene = new Scene(boardLayout, 400, 400);
    ...
    public void showWinner(int playerID) {
        Platform.runLater(() -> {
            ...
            if (player.getSessionId() == playerID) {
                ...
                wonLabel.setTextFill(Color.LIGHTGREEN);
            } else {
                wonLabel.setText("YOU LOST!");
                wonLabel.setTextFill(Color.RED);
            }
            boardLayout.getChildren().add(vbox);
        });
    }
